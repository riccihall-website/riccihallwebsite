...
for($i=0;$i<count($rowsArray);$i++){
	...
	if ($itemArray[2]=='Active') {
		if ($itemArray[4]) { // redirect link
			print("<td align=center valign=bottom><a href=\"$itemArray[4]\" target=_blank>$tempThumb<br><font color=#000000>".getLang($itemArray[1])."</font></a><br>$tempcontent</td>\n");
		} elseif ($itemArray[7]) {
