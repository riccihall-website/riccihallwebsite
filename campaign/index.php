...
.sample 	{font-family: "Arial";	font-size: 10px;	font-style: italic;		color: #<?print(getStyle("formsample"))?>;}
...
function banner() {
	print("<table border=0 width=1000 cellpadding=0 cellspacing=0><tr bgcolor=#ffffff><td valign=bottom><a href=./><img src=\"upload/Style/".getStyle("Logo")."\" border=0></a></td>");
